...
import s from "../FlashSales/FlashSales.module.css";
...
const RelatdProduct: FunctionComponent<Props> = ({ products, title, routerId }) => {
        ...
        <div className="my-28">
          ...
          </div>
          {
            <>
              ...
              <Slider
            ref={sliderRef}
            slidesToShow={(Object.entries(avaliableProducts).length > 4 ) ? 4 : Object.entries(avaliableProducts).length }
            rtl={dir.rtl}
            className={s.slider}
            draggable={true}
            centerMode={true}
