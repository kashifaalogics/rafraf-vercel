...
import { AccountInfoForm, AccountLayout } from "@components/account";
  ...
  return (
    <>
      ...
      <Container className="py-5">
        ...
        <AccountLayout active="info">
          <div className="formChnagePass flex">
          <AccountInfoForm />
          {showDiv1 && <ChangePasswordForm />}
        </div>
        <label className="label_changePass">
            <input
              type="checkbox"
              checked={showDiv1}
