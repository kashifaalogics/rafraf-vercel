    ...
    <div>    
      ...
      <div className="relative block md:hidden">
        <Container>
          <div className="pt-12">
            <div className="mt-6">
              <H4>{t("static/blogs:blog_11.title")}</H4>
              <div
                style={{
                  marginTop: "12px",
                }}
              >
                {t("static/blogs:blog_11.date")}
              </div>
              <div className="mb-16">
                <P>
                  <div className="mt-16">
                    ...
                    <div className="my-8 mx-8">
                        ...
                        <div className="my-10">
                            ...
                            <div className="pb-3">{t("static/blogs:blog_11.content.intro_1")}</div>
                            <H4 className="pb-3">{t("static/blogs:blog_11.content.head_1")}</H4>

                            <ul>
                            <li className="pb-7">{t("static/blogs:blog_11.content.body_1_1")}</li>
                            <li className="pb-7">{t("static/blogs:blog_11.content.body_1_2")}</li>
                            <H4 className="pb-3">{t("static/blogs:blog_11.content.head_2")}</H4>
                  ...
                  <Container className="pb-1">
                    ...
                    >
                      <div className="mt-6 mx-8">
                        <H3>{t("static/blogs:blog_11.title")}</H3>
                        <div
                          style={{
                            marginTop: "35px",
                          }}
