    ...
    <div>    
      ...
      <div className="relative block md:hidden">
        <Container>
          <div className="pt-12">
            <div className="mt-6">
              <H4>{t("static/blogs:blog_12.title")}</H4>
              <div
                style={{
                  marginTop: "12px",
                }}
              >
                {t("static/blogs:blog_12.date")}
              </div>
              <div className="mb-16">
                <P>
                  <div className="mt-16">
                    ...
                    <div className="my-8 mx-8">
                        ...
                        <div className="my-10">
                            <img
                                src={t("static/blogs:blog_12.imageUrl")}
                                alt="blog-image"
                            />
                            </div>
                            <H4 className="pb-3">{t("static/blogs:blog_12.content.intro_1")}</H4>
                            <ul>
                            <li className="pb-7">{t("static/blogs:blog_12.content.body_1_1")}</li>
                            <li className="pb-7">{t("static/blogs:blog_12.content.body_1_2")}</li>
                            </ul>
                  ...
                  <Container className="pb-1">
                    ...
                    >
                      <div className="mt-6 mx-8">
                        <H3>{t("static/blogs:blog_12.title")}</H3>
                        <div
                          style={{
                            marginTop: "35px",
                          }}
