    ...
    <div>    
      ...
      <div className="relative block md:hidden">
        <Container>
          <div className="pt-12">
            <div className="mt-6">
              <H4>{t("static/blogs:blog_13.title")}</H4>
              <div
                style={{
                  marginTop: "12px",
                }}
              >
                {t("static/blogs:blog_13.date")}
              </div>
              <div className="mb-16">
                <P>
                  <div className="mt-16">
                    ...
                    <div className="my-8 mx-8">
                        ...
                        <div className="my-10">
                            ...
                            <H3 className="pb-3">{t("static/blogs:blog_13.content.intro_1")}</H3>
                            <ul>
                            <p className="pb-7">{t("static/blogs:blog_13.content.body_1_1")}</p>
                            <p className="pb-7">{t("static/blogs:blog_13.content.body_1_2")}</p>
                            <H4 className="pb-7">{t("static/blogs:blog_13.content.body_1_3")}</H4>
                            <p className="pb-7">{t("static/blogs:blog_13.content.body_1_4")}</p>
                            <H4 className="pb-7">{t("static/blogs:blog_13.content.body_1_5")}</H4>
                  ...
                  <Container className="pb-1">
                    ...
                    >
                      <div className="mt-6 mx-8">
                        <H3>{t("static/blogs:blog_13.title")}</H3>
                        <div
                          style={{
                            marginTop: "35px",
                          }}
