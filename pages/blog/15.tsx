    ...
    <div>    
      ...
      <div className="relative block md:hidden">
        <Container>
          <div className="pt-12">
            <div className="mt-6">
              <H4>{t("static/blogs:blog_15.title")}</H4>
              <div
                style={{
                  marginTop: "12px",
                }}
              >
                {t("static/blogs:blog_15.date")}
              </div>
              <div className="mb-16">
                <P>
                  <div className="mt-16">
                    ...
                    <div className="my-8 mx-8">
                        ...
                        <div className="my-10">
                            <img
                                src={t("static/blogs:blog_15.imageUrl")}
                                alt="blog-image"
                            />
                            </div>
                            <H3 className="pb-3">{t("static/blogs:blog_15.content.intro_1")}</H3>
                            <ul>
                            <p className="pb-7">{t("static/blogs:blog_15.content.body_1_1")}</p>
                            <H4 className="pb-7">{t("static/blogs:blog_15.content.body_1_2")}</H4>
                            <p className="pb-7">{t("static/blogs:blog_15.content.body_1_3")}</p>
                            <H4 className="pb-7">{t("static/blogs:blog_15.content.body_1_4")}</H4>
                            <ul>
                            <li className="pb-7 list-disc">{t("static/blogs:blog_15.content.body_1_5")}</li>
                            <li className="pb-7 list-disc">{t("static/blogs:blog_15.content.body_1_6")}</li>
                            <li className="pb-7 list-disc">{t("static/blogs:blog_15.content.body_1_7")}</li>
                            <li className="pb-7 list-disc">{t("static/blogs:blog_15.content.body_1_8")}</li>
                            </ul>
                            </ul>
                  ...
                  <Container className="pb-1">
                    ...
                    >
                      <div className="mt-6 mx-8">
                        <H3>{t("static/blogs:blog_15.title")}</H3>
                        <div
                          style={{
                            marginTop: "35px",
                          }}
                    ...
                    >
                      <div className="my-8 mx-8">
                        ...
                        <img
                            ...
                            <H4 className="pb-7">{t("static/blogs:blog_15.content.body_1_9")}</H4>
