                ...
                <P>
                  <div className="mt-16">
                    ...
                    <div className="my-8 mx-8">
                        <div>{t("static/blogs:blog_2.body.intro_1")}</div>
                        ...
                        <div className="mt-2">
                          <H4>{t("static/blogs:blog_2.body.header_1")}</H4>
                        </div>
                        <div className="mt-3">
                          <div>
                            {t("static/blogs:blog_2.body.body_1")}
                          </div>
                        </div>

                        <div className="mt-10">
                          <H4>{t("static/blogs:blog_2.body.header_2")}</H4>
                        </div>
                        <div className="mt-3">
                          <div>
                            {t("static/blogs:blog_2.body.body_2")}
                          </div>
                        </div>

                        <div className="mt-10">
                          <H4>{t("static/blogs:blog_2.body.header_3")}</H4>
                        </div>
                        <div className="mt-3">
                          <div>
                            {t("static/blogs:blog_2.body.body_3.content")}
                          </div>

                          <ul className="list-disc">
                            <li>{t("static/blogs:blog_2.body.body_3.option_1")}</li>
                            <li>{t("static/blogs:blog_2.body.body_3.option_2")}</li>
                            <li>{t("static/blogs:blog_2.body.body_3.option_3")}</li>
                          </ul>
                        </div>
                  ...
                  <Container className="pb-1">
                    ...
                    >
                      <div className="mt-6 mx-8">
                        <H3>{t("static/blogs:blog_2.title")}</H3>
                        <div
                          style={{
                            marginTop: "50px",
                          }}
