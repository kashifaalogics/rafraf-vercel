                ...
                <P>
                  <div className="mt-16">
                    ...
                    <div className="my-8 mx-8">
                        <div>{t("static/blogs:blog_3.content.intro")}</div>
                        <div>{t("static/blogs:blog_3.content.body")}</div>
                  ...
                  <Container className="pb-1">
                    ...
                    >
                      <div className="mt-6 mx-8">
                        <H3>{t("static/blogs:blog_3.title")}</H3>
                        <div
                          style={{
                            marginTop: "50px",
                          }}
                        >
                          {t("static/blogs:blog_3.date")}
                        </div>
                      </div>
                    </div>
                  </Container>
              ...
              <div>
                <div className="pb-12">
                  ...
                  <Container className="pb-9">
                    ...
                    >
                      <div className="my-8 mx-8">
                        <div className="pb-3">{t("static/blogs:blog_3.content.intro")}</div>
                        <div className="pb-3">{t("static/blogs:blog_3.content.body")}</div>
                        <div>{t("static/blogs:blog_3.content.footer")}</div>
