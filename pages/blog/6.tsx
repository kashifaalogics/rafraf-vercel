    ...
    <div>    
      ...
      <div className="relative block md:hidden">
        <Container>
          <div className="pt-12">
            <div className="mt-6">
              <H4>{t("static/blogs:blog_6.title")}</H4>
              <div
                style={{
                  marginTop: "12px",
                }}
              >
                {t("static/blogs:blog_6.date")}
              </div>
              <div className="mb-16">
                <P>
                  <div className="mt-16">
                    ...
                    <div className="my-8 mx-8">
                        ...
                        <div className="my-10">
                            <img
                                src={t("static/blogs:blog_6.imageUrl")}
                                alt="blog-image"
                            />
                            </div>

                            <div className="pb-3">{t("static/blogs:blog_6.content.intro_1")}</div>
                            <div className="pb-7">{t("static/blogs:blog_6.content.intro_2")}</div>

                            <H4 className="pb-3">{t("static/blogs:blog_6.content.head_1")}</H4>
                            <div className="pb-7">{t("static/blogs:blog_6.content.body_1_1")}</div>
                            <div className="pb-7">{t("static/blogs:blog_6.content.body_1_2")}</div>

                            <H4 className="pb-3">{t("static/blogs:blog_6.content.head_2")}</H4>
                            <div className="pb-7">{t("static/blogs:blog_6.content.body_2")}</div>

                            <H4 className="pb-3">{t("static/blogs:blog_6.content.head_3")}</H4>
                            <div className="pb-7">{t("static/blogs:blog_6.content.body_3")}</div>

                            <H4 className="pb-3">{t("static/blogs:blog_6.content.head_4")}</H4>
                            <div className="pb-7">{t("static/blogs:blog_6.content.body_4")}</div>

                            <H4 className="pb-3">{t("static/blogs:blog_6.content.head_5")}</H4>
                            <div className="pb-7">{t("static/blogs:blog_6.content.body_5_1")}</div>
                            <div className="pb-7">{t("static/blogs:blog_6.content.body_5_2")}</div>

                            <H4>{t("static/blogs:blog_6.content.footer_title")}</H4>
                            <div>{t("static/blogs:blog_6.content.footer_body_1")}</div>
                            <div>{t("static/blogs:blog_6.content.footer_body_2")}</div>
                  ...
                  <Container className="pb-1">
                    ...
                    >
                      <div className="mt-6 mx-8">
                        <H3>{t("static/blogs:blog_6.title")}</H3>
                        <div
                          style={{
                            marginTop: "35px",
                          }}
