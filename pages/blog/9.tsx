    ...
    <div>    
      ...
      <div className="relative block md:hidden">
        <Container>
          <div className="pt-12">
            <div className="mt-6">
              <H4>{t("static/blogs:blog_9.title")}</H4>
              <div
                style={{
                  marginTop: "12px",
                }}
              >
                {t("static/blogs:blog_9.date")}
              </div>
              <div className="mb-16">
                <P>
                  <div className="mt-16">
                    ...
                    <div className="my-8 mx-8">
                        ...
                        <div className="my-10">
                            <img
                                src={t("static/blogs:blog_9.imageUrl")}
                                alt="blog-image"
                            />
                            </div>
                            <div className="pb-3">{t("static/blogs:blog_9.content.intro_1")}</div>
                            <H4 className="pb-3">{t("static/blogs:blog_9.content.head_1")}</H4>
                            <ul>
                            <li className="pb-7">{t("static/blogs:blog_9.content.body_1_1")}</li>
                            <li className="pb-7">{t("static/blogs:blog_9.content.body_1_2")}</li>
                            <H4 className="pb-3"> {t("static/blogs:blog_9.content.head_2")}</H4>
                            <li className="pb-7">{t("static/blogs:blog_9.content.body_2")}</li>
                            <li className="pb-7">{t("static/blogs:blog_9.content.body_3")}</li>
                            <li className="pb-7">{t("static/blogs:blog_9.content.body_3_1")}</li>
                            </ul>
                            
                            <ul className="pb-7">{t("static/blogs:blog_9.content.body_3_2")}</ul>
                            <div className="pb-7">{t("static/blogs:blog_9.content.body_3_3")}</div>

                            <div className="pb-3">{t("static/blogs:blog_9.content.head_6")}</div>
                            <div className="pb-7">{t("static/blogs:blog_9.content.head_7")}</div>
                            <div className="pb-7">{t("static/blogs:blog_9.content.head_8")}</div>
                            <div className="pb-7">{t("static/blogs:blog_9.content.head_9")}</div>
                  ...
                  <Container className="pb-1">
                    ...
                    >
                      <div className="mt-6 mx-8">
                        <H3>{t("static/blogs:blog_9.title")}</H3>
                        <div
                          style={{
                            marginTop: "35px",
                          }}
                    ...
                    >
                      <div className="my-8 mx-8">
                        <div className="my-10">
                            ...
                            <li className="pb-7">{t("static/blogs:blog_9.content.body_1_2")}</li>
                            <H4 className="pb-3"> {t("static/blogs:blog_9.content.head_2")}</H4>
                            <li className="pb-7">{t("static/blogs:blog_9.content.body3")}</li>
                            <li className="pb-7">{t("static/blogs:blog_9.content.body_3_1")}</li>
                            <li className="pb-7">{t("static/blogs:blog_9.content.body_3_2")}</li>
                            <li className="pb-7">{t("static/blogs:blog_9.content.body_3_3")}</li>
                            <li className="pb-7">{t("static/blogs:blog_9.content.body_3_4")}</li>
                            </ul>
                            <div className="pb-3">{t("static/blogs:blog_9.content.head_6")}</div>
                            <div className="pb-7">{t("static/blogs:blog_9.content.head_7")}</div>
                            <div className="pb-7">{t("static/blogs:blog_9.content.head_8")}</div>
