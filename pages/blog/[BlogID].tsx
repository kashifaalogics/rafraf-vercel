    ...
    <>
      ...
      <div className="relative block md:hidden">
        <Container>
          <div className="pt-12">
            <div className="mt-6">
              <H4>{t("static/blogs:blog_1.title")}</H4>
              <div
                style={{
                  marginTop: "12px",
                }}
              ...
              <div className="mb-16">
                <P>
                  <div className="mt-16">
                    لا شك بأن أي سيارة جديدة تحتاج إلى فترة عناية أو مايسمى
                    بفترة التليين وذلك عند شرائها كون بعض قطع غيار تحتاج إلى
                    التجانس والتأقلم مع قطع الغيار الاخرى في السيارة. كانت
                    السيارات في السابق تحتاج لفترة تليين طويلة ريثما تتأقلم
                    أجزاء السيارة مع بعضها البعض ولكن وبسبب التقدم التكنولوجي
                    الذي تعتمده شركات السيارات في التصنيع تناقصت فترة إلى مايصل
                    ...
                    <div className="mt-2">
                      <H4>
                        إليك عزيزي السائق بعض النصائح التي يجب عليك اتباعها
                        لتحافظ على سيارتك الجديدة في بداية قيادتها:
                      </H4>
                    </div>
                    <div className="mt-3">
                      <div>
                        - عدم المبالغة بالضغط على دواسة الوقود، فالضغط الزائد
                        على الدواسة يضر بأجزاء المحرك الداخلية كما يؤدي إلى
                        زيادة في استهلاك الزيت وبالتالي تناقص عمره الافتراضي.
                      </div>
                      <div>
                        - السير بسرعات منخفضة وعدم القيادة بسرعات عالية للحفاظ
                        على الفرامل وتجنُّب الضغط على المحرك.
                      </div>
                      <div>
                        - احذر القيادة في الطرق الوعرة وغير الممهدة لتجنب الضغط
                        على المساعدات ( ممتصات الصدمات).
                      </div>
                      <div>- تجنب تحميل السيارة بأوزان زائدة.</div>
                      <div>- ضبط ضغط الهواء في الإطارات بشكل مستمر.</div>
                      <div>
                        - تفقد سوائل السيارة بشكل أسبوعي في الفترى الأولى.
                      </div>
                      <div>
                        - تغيير الزيت عند انتهاء فترة التليين وذلك لتلوثه
                        ببرادات الحديد.
                      </div>
                      <div>
                        - تسخين محرك السيارة جيداً قبل السير وذلك من اجل رفع
                        درجة حرارة الزيت فقيادة السيارة في حال الزيت بارداً يفقد
                        من عزم المحرك على المدى البعيد.
                      </div>
                      <div>
                        - عدم تجاوز معدل دوران محرك السيارة لثلاثة آلاف دورة في
                        الدقيقة خلال الفترة الأولى.
                      </div>
                      <div>
                        اتبع نصائح وإرشادات العناية بالسيارة فالمحافظة على
                        سيارتك في الفترة الأولى من شرائها ستكون نتائجه واضحة مع
                        مرور الوقت وتقدم العمر الافتراضي للسيارة ولقطع الغيار
                        والأجزاء المكونة لها.
                      </div>

                      <div>
                        متجر رفرف الإلكتروني يوفّر مجموعة واسعة من قطع الغيار
                        الأصلية Genuine و OEM وقطع الغيار البديلة المعتمدة
                        Aftermarket لمختلف أنواع سيارات{" "}
                        <a href="https://rafraf.com/ar/cars/toyota">تويوتا</a>{" "}
                        وهوندا{" "}
                        <a href="https://rafraf.com/ar/cars/gmc">والجمس </a>
                        <a href="https://rafraf.com/ar/cars/chevrolet">
                          والشفروليه
                        </a>{" "}
                        <a href="https://rafraf.com/ar/cars/ford">والفورد</a>{" "}
                        ...
                        وغيرها، ونقوم أيضاً بتلبية جميع متطلبات السوق السعودي من{" "}
                        <a href="">الزيوت </a>{" "}
                  ...
                  <Container className="pb-1">
                    ...
                    >
                      <div className="mt-6 mx-8">
                        <H3>{t("static/blogs:blog_1.title")}</H3>
                        <div
                          style={{
                            marginTop: "50px",
                          }}
                  ...
                  <Container className="pb-9">
                    ...
                    >
                      <div className="mt-8 mx-8">
                        ...
                        التجانس والتأقلم مع قطع الغيار الاخرى في السيارة. كانت
                        السيارات في السابق تحتاج لفترة تليين طويلة ريثما تتأقلم
                        أجزاء السيارة مع بعضها البعض ولكن وبسبب التقدم
                        التكنولوجي الذي تعتمده شركات السيارات في التصنيع تناقصت
                        ...
                        <div className="mt-3">
                          <div>
                            - عدم المبالغة بالضغط على دواسة الوقود، فالضغط
                            الزائد على الدواسة يضر بأجزاء المحرك الداخلية كما
                            يؤدي إلى زيادة في استهلاك الزيت وبالتالي تناقص عمره
                            الافتراضي.
                          </div>
                          <div>
                            - السير بسرعات منخفضة وعدم القيادة بسرعات عالية
                            للحفاظ على الفرامل وتجنُّب الضغط على المحرك.
                          </div>
                          <div>
                            - احذر القيادة في الطرق الوعرة وغير الممهدة لتجنب
                            الضغط على المساعدات ( ممتصات الصدمات).
                          </div>
                          <div>- تجنب تحميل السيارة بأوزان زائدة.</div>
                          <div>- ضبط ضغط الهواء في الإطارات بشكل مستمر.</div>
                          <div>
                          ...
                          <div>
                            - تسخين محرك السيارة جيداً قبل السير وذلك من اجل رفع
                            درجة حرارة الزيت فقيادة السيارة في حال الزيت بارداً
                            يفقد من عزم المحرك على المدى البعيد.
                          </div>
                          <div>
                            - عدم تجاوز معدل دوران محرك السيارة لثلاثة آلاف دورة
                            في الدقيقة خلال الفترة الأولى.
                          </div>
                          <div>
                            اتبع نصائح وإرشادات العناية بالسيارة فالمحافظة على
                            سيارتك في الفترة الأولى من شرائها ستكون نتائجه واضحة
                            مع مرور الوقت وتقدم العمر الافتراضي للسيارة ولقطع
                            الغيار والأجزاء المكونة لها.
                          </div>
