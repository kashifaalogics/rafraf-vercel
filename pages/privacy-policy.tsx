...
import { A, H1, H2, H3, H4, H6 } from "@components/typography";
...
export default function PrivacyPol({
  ...
  const refF = useRef<HTMLParagraphElement>(null);
  const refG = useRef<HTMLParagraphElement>(null);
  const refH = useRef<HTMLParagraphElement>(null);
  const refI = useRef<HTMLParagraphElement>(null);
  ...
  return (
    <>
    <Head>
      <link rel="canonical" href={`https://rafraf.com/${rtl? "ar" : "en"}/privacy-policy`} />
      <title>{t("static/privacy-policy:title")} | {t("common:rafraf")}</title>
    </Head>
    <div  className={`flex ${rtl ? "flex-row-reverse" : ""} gap-8`} >
      <Container>
        <div className= "flex  flex-wrap gap-8">         
          <div className="flex-1">
            <div className="py-12 ">
              <H2 >{t("static/privacy-policy:header.text")}</H2>  
            </div>
            <H4 className="pb-3">{t("static/privacy-policy:What.title")}</H4>
            <p className=" pb-6">{t("static/privacy-policy:What.text")}</p>                
            <div  >
              <p className="pb-3 font-bold" ref={refA}>{t("static/privacy-policy:href.A")}</p>
              <p  className="pb-6">{t("static/privacy-policy:body.A")}</p>                
            </div>
              <div className="border-b-2 mb-8">
            </div>
            <div>
              <p className="pb-3 font-bold" ref={refB}>{t("static/privacy-policy:href.B")}</p>
              <p  className="pb-6">{t("static/privacy-policy:body.B")}</p>                
            </div>
            <div className="border-b-2 mb-8">
            </div>
            <div>
              <p className="pb-3 font-bold"  ref={refC}>{t("static/privacy-policy:href.C")}</p>
              <p  className="pb-6">{t("static/privacy-policy:body.C")}</p>                
            </div>
            <div className="border-b-2 mb-8">
            </div>
            <div>
              <p className="pb-3 font-bold"  ref={refD}>{t("static/privacy-policy:href.D")}</p>
              <p  className="pb-6">{t("static/privacy-policy:body.D")}</p>                
            </div>
            <div className="border-b-2 mb-8">
            </div>
            <div>
              <p className="pb-3 font-bold" ref={refE}>{t("static/privacy-policy:href.E")}</p>
              <p  className="pb-6">{t("static/privacy-policy:body.D")}</p>  
              <p  className="pb-2 text-center">info@rafraf.com</p>                   
            </div>
            <div className="border-b-2 mb-8">
            </div>
            <div>
              <p className="pb-3 font-bold" ref={refF}>{t("static/privacy-policy:href.F")}</p>
              <p  className="pb-6">{t("static/privacy-policy:body.F")}</p>                
            </div>
            <div className="border-b-2 mb-8">
            </div>
            <div>
              <p className="pb-3 font-bold" ref={refG}>{t("static/privacy-policy:href.G")}</p>
              <p  className="pb-6">{t("static/privacy-policy:body.G")}</p>                
            </div>
            <div className="border-b-2 mb-8">
            </div>
            <div>
              <p className="pb-3 font-bold" ref={refH}>{t("static/privacy-policy:href.H")}</p>
              <p  className="pb-6">{t("static/privacy-policy:body.H")}</p>                
            </div>
            <div className="border-b-2 mb-8">
            </div>
            <div>
              <p className="pb-3 font-bold" ref={refI}>{t("static/privacy-policy:href.I")}</p>
              <p  className="pb-9">{t("static/privacy-policy:body.I")}</p>               
            </div>
          </div>

          <div className="flex-1 py-36 hidden  md:block lg:block ">  
            <div className=" w-full h-80  text-center  shadow-md">
             <H6 className="pb-3 pt-1 cursor-pointer" onClick={() => focus(refA)}>{t("static/privacy-policy:href.A")}</H6>
             <H6 className="pb-3 cursor-pointer" onClick={() => focus(refB)}>{t("static/privacy-policy:href.B")}</H6>
             <H6 className="pb-3 cursor-pointer" onClick={() => focus(refC)}>{t("static/privacy-policy:href.C")}</H6>
             <H6 className="pb-3 cursor-pointer" onClick={() => focus(refD)}>{t("static/privacy-policy:href.D")}</H6>
             <H6 className="pb-3 cursor-pointer" onClick={() => focus(refE)}>{t("static/privacy-policy:href.E")}</H6>
             <H6 className="pb-3 cursor-pointer" onClick={() => focus(refF)}>{t("static/privacy-policy:href.F")}</H6>
             <H6 className="pb-3 cursor-pointer" onClick={() => focus(refG)}>{t("static/privacy-policy:href.G")}</H6>
             <H6 className="pb-3 cursor-pointer" onClick={() => focus(refH)}>{t("static/privacy-policy:href.H")}</H6>
             <H6 className="pb-3 cursor-pointer" onClick={() => focus(refI)}>{t("static/privacy-policy:href.I")}</H6>
            </div>              
          </div>
        ...
        <H4 className="text-center pb-4">{t("static/privacy-policy:soial.text1")}</H4>         
          <div className="flex justify-center">
            <p className="w-3/5 text-center">{t("static/privacy-policy:soial.text2")}</p>
          </div>
          <div className="flex  flex-wrap gap-28 justify-center py-6">
          ...
          <H4 >{t("static/privacy-policy:contact.text1")}</H4>
          <p className="py-4">{t("static/privacy-policy:contact.text2")}</p>
          <div className="flex  flex-wrap gap-20 justify-center">
            <p className="font-bold underline	"><a href="https://rafraf.com" >{t("static/privacy-policy:contact.rafraf_app")}</a></p>
            <p className="font-bold underline"><a href="https://api.whatsapp.com/send/?phone=966536722255&text&app_absent=0" >{t("static/privacy-policy:contact.whatsapp")}</a></p>
            <p className="font-bold underline"><a href="mailto:info@rafraf.com" >{t("static/privacy-policy:contact.e-mail")}</a></p>
            <p className="font-bold underline"><a href="https://rafraf.com" >{t("static/privacy-policy:contact.help_center")}</a></p>
          </div>
       </div>           
      </Container> 
    </div>
