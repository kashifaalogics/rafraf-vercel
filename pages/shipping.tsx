...
export default function Shipping({
  ...
  return (
    ...
    <>
      <Head>
        <title>{t("static/shipping:title")} | {t("common:rafraf")}</title>
        <link rel="canonical" href={`'https://rafraf.com/${rtl? "ar" : "en"}/shipping`} />
      </Head>
      ...
      <div className={`flex ${rtl ? "flex-row-reverse" : ""} py-12`}>
        ...
        <div className="py-12">
          <Container className="pb-9">
            <H1>{t("static/shipping:title")}</H1>
          </Container>
          <Container>
            <section>
              <H3 className="text-center">
                {t("static/shipping:firstparagraph.title")}
              </H3>
              <div className="m-10 p-7 flex flex-col gap-7 shadow-inner hover:shadow-lg mt-6 border-gray border-2">
                <P>
                  <strong>
                    {t("static/shipping:firstparagraph.paymentmethod")}
                  </strong>
                  <br></br>
                  {t("static/shipping:firstparagraph.paymentmethodan")}
                </P>
                <P>
                  <strong>
                    {t("static/shipping:firstparagraph.banktransfer")}
                  </strong>
                  <br></br>
                  {t("static/shipping:firstparagraph.banktransferan")}
                </P>
                <P>
                  <strong>{t("static/shipping:firstparagraph.safe")}</strong>
                  <br></br>
                  {t("static/shipping:firstparagraph.safean")}
                </P>
              </div>
            </section>
          </Container>
          ...
          <Container>
            <section>
              <H3 className="text-center">
                {t("static/shipping:secondparagraph.title")}
              </H3>
              <div className="m-10 p-7 flex flex-col gap-7 hover:shadow-lg shadow-md mt-6 border-gray border-2">
                <P>
                  <strong>
                    {t("static/shipping:secondparagraph.shippingcoverage")}
                  </strong>
                  <br></br>
                  {t("static/shipping:secondparagraph.shippingcoveragean")}
                </P>
                <P>
                  <strong>
                    {t("static/shipping:secondparagraph.shippingduration")}
                  </strong>
                  <br></br>
                  {t("static/shipping:secondparagraph.shippingdurationan")}
                  <br></br>
                  <br></br>
                  {t("static/shipping:secondparagraph.shippingdurationan2")}
                </P>
                <P>
                  <strong>{t("static/shipping:secondparagraph.shippingfees")}</strong>
                  <br></br>
                  {t("static/shipping:secondparagraph.shippingfeesan")}
                </P>
              </div>
            </section>
          </Container>
          ...
          <Container className="py-16">
            <H4 className="text-center pb-4">
              {t("static/shipping:footer.info")}
            </H4>
            <div className="flex justify-center">
              <p className="w-3/5 text-center">
                {" "}
                {t("static/shipping:footer.privacy_shipping")}
              </p>
            </div>
            <div className="flex flex-wrap gap-28 justify-center py-6">
              {socialLinks.map((sl, i) => (
                ...
                >
                  <sl.Icon className="rounded-full shadow-inner hover:shadow-lg" />
                  <span>{sl.title}</span>
                </A>
              ))}
            </div>
            ...
            <div className="py-3 text-center">
              <H4>
              {t("static/shipping:footer.inquiry")}
              </H4>
              <p className="py-4">{t("static/shipping:footer.contact")}</p>
              <div className="flex flex-wrap gap-20 justify-center">
                <p className="font-bold underline	">
                  <a href="https://rafraf.com">{t("static/shipping:footer.channels.rafraf_app")}</a>
                </p>
                <p className="font-bold underline">
                  <a href="https://api.whatsapp.com/send/?phone=966536722255&text&app_absent=0">
                  {t("static/shipping:footer.channels.whatsapp")}
                  </a>
                </p>
                <p className="font-bold underline">
                  <a href="mailto:info@rafraf.com">{t("static/shipping:footer.channels.e-mail")}</a>
                </p>
                <p className="font-bold underline">
                  <a href="https://rafraf.com">{t("static/shipping:footer.channels.help_center")}</a>
                </p>
              </div>
            </div>
          </Container>
