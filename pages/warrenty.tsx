...
const FacebookFilledIcon = ({ color = "#3C425A" }: any) => {
    return (
      <svg
        width="52"
        height="52"
  ...
  const TwitterFilledIcon = ({ color = "#3C425A" }) => {
    return (
      <svg
        width="52"
        height="52"
  ...
  const InstagramFilledIcon = ({ color = "#3C425A" }) => {
    return (
      <svg
        width="52"
        height="52"
  ...
  const YoutubeFilledIcon = ({ color = "#3C425A" }) => {
    return (
      <svg
        width="52"
        height="52"
...
export default function Warrenty({
  categories,
    ...
    const refA = useRef<HTMLParagraphElement>(null);
    const refB = useRef<HTMLParagraphElement>(null);
    const refC = useRef<HTMLParagraphElement>(null);
    const refD = useRef<HTMLParagraphElement>(null);
    const refE = useRef<HTMLParagraphElement>(null);

    function focus (ref:  RefObject<HTMLParagraphElement>){  
  ...
  return (
    ...
    <>
    <Head>
      <title>{t("static/warrenty:title")} | {t("common:rafraf")}</title>
      <link rel="canonical" href={`https://rafraf.com/${rtl? "ar": "en"}/warrenty`} />
    </Head>
      <div className={`flex ${rtl ? "flex-row-reverse" : ""} py-12`}>
        <Container className="pb-9">

          <div className="flex flex-wrap py-6">
            <div className="flex flex-col gap-y-12 md:w-3/4 lg:w-3/4 ">
                <section ref={refA}>
                    <h1   className="pb-4 text-2xl font-bold">{t("static/warrenty:clauses.title")}</h1> 
                    <div>
                        <ol className="list-decimal px-3 md:px-14 lg:px-14">  
                            <li className="px-3 md:px-8 pb-3">{t("static/warrenty:clauses.fisrt")}</li>
                            <li className="px-3 md:px-8 pb-3">{t("static/warrenty:clauses.second")}</li>
                            <li className="px-3 md:px-8 pb-3">{t("static/warrenty:clauses.third")}</li>
                            <li className="px-3 md:px-8 pb-3">{t("static/warrenty:clauses.fourth")}</li>
                        </ol>
                    </div>
                </section>
                <section ref={refB}> 
                    <H4 className="pb-4">{t("static/warrenty:matching.title")}</H4>
                    <p> {t("static/warrenty:matching.text")}</p>
                </section>
                <section ref={refC}>
                    <H4 className="pb-4">{t("static/warrenty:excluded.title")}:</H4>
                    <ol className="list-decimal px-3 md:px-14 lg:px-14">  
                            <li className="px-3 md:px-8 pb-3">{t("static/warrenty:excluded.first")}</li>
                            <li className="px-3 md:px-8 pb-3">{t("static/warrenty:excluded.second")}</li>
                            <li className="px-3 md:px-8 pb-3">{t("static/warrenty:excluded.third")}</li>
                            <li className="px-3 md:px-8 pb-3">{t("static/warrenty:excluded.fourth")}</li>
                            <li className="px-3 md:px-8 pb-3">{t("static/warrenty:excluded.fifth")}</li>
                            <li className="px-3 md:px-8 pb-3">{t("static/warrenty:excluded.sixth")}</li>
                    </ol>
                </section>
                <section ref={refD}>
                    <H4 className="pb-4">{t("static/warrenty:return_cancel.title")}</H4>
                    <p className="pb-2">{t("static/warrenty:return_cancel.content.text")}</p>
                    <ul className="list-disc px-3 md:px-14 lg:px-14">  
                            <li className="px-3 md:px-7 lg:px-7 pb-2">{t("static/warrenty:return_cancel.content.first")}</li>
                            <li className="px-3 md:px-7 lg:px-7 pb-2">{t("static/warrenty:return_cancel.content.second")}</li>
                    </ul>
                </section>
                <section ref={refE}>
                    <H4 className="pb-4">{t("static/warrenty:return_cases.title")}:</H4>
                    <ol className="list-decimal px-3 md:px-14 lg:px-14">
                        <li className="font-bold px-3 md:px-8 lg:px-8 pb-2">{t("static/warrenty:return_cases.cases.first_case")}</li>
                        <p className="md:px-8 lg:px-8 pb-3">{t("static/warrenty:return_cases.cases.first_case_details")}</p>
                        <li className="font-bold px-3 md:px-8 lg:px-8 pb-2">{t("static/warrenty:return_cases.cases.second_case")}</li>
                        <p className="md:px-8 lg:px-8pb-3">{t("static/warrenty:return_cases.cases.second_case_details")}</p>
                        {/* <li className="font-bold px-3 md:px-8 lg:px-8 pb-2">{t("static/warrenty:return_cases.cases.third_case")}</li>
                        <p className="md:px-8 lg:px-8 pb-3">{t("static/warrenty:return_cases.cases.third_case_details")}</p> */}
                    </ol>
                </section>
            </div>
            <div className="w-1/4 hidden md:block lg:block">
                <div className="shadow-md p-7">
                    <H5 onClick={() => focus(refA)} className="pb-3 cursor-pointer">{t("static/warrenty:clauses.title")}</H5>
                    <H5 onClick={() => focus(refB)} className="pb-3 cursor-pointer">{t("static/warrenty:matching.title")}</H5>
                    <H5 onClick={() => focus(refC)} className="pb-3 cursor-pointer">{t("static/warrenty:excluded.title")}</H5>
                    <H5 onClick={() => focus(refD)} className="pb-3 cursor-pointer">{t("static/warrenty:return_cancel.title")}</H5>
                    <H5 onClick={() => focus(refE)} className="pb-3 cursor-pointer">{t("static/warrenty:return_cases.title")}</H5>
                </div>
            </div>

          </div>

          <H4 className="text-center pb-4">{t("static/warrenty:footer.info")}</H4>
          
          <div className="flex justify-center">
            <p className="w-3/5 text-center">{t("static/warrenty:footer.privacy_shipping")}</p>
          </div>
          
          <div className="flex flex-wrap justify-center gap-28 mt-6">
          ...
          <div className="text-center ">
            <H4 className="pt-9">{t("static/warrenty:footer.inquiry")}</H4>
            <p className="py-6"></p>
            <div className="flex flex-wrap justify-center gap-20">
                <p className="font-bold underline"><a href="https://rafraf.com" >{t("static/warrenty:footer.channels.rafraf_app")}</a></p>
                <p className="font-bold underline"><a href="https://api.whatsapp.com/send/?phone=966536722255&text&app_absent=0" >{t("static/warrenty:footer.channels.whatsapp")}</a></p>
                <p className="font-bold underline"><a href="mailto:info@rafraf.com" >{t("static/warrenty:footer.channels.e-mail")}</a></p>
                <p className="font-bold underline"><a href="https://rafraf.com" >{t("static/warrenty:footer.channels.help_center")}</a></p>
            </div>
          </div>
        </Container>
      </div>
